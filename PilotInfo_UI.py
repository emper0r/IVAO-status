...
#
# Created: Wed Sep  7 09:16:15 2011
...
class Ui_QPilotInfo(object):
    def setupUi(self, QPilotInfo):
        ...
        QPilotInfo.setWindowModality(QtCore.Qt.NonModal)
        QPilotInfo.resize(491, 500)
        ...
        QPilotInfo.setMinimumSize(QtCore.QSize(491, 500))
        QPilotInfo.setMaximumSize(QtCore.QSize(491, 500))
        ...
        self.airline_image.setGeometry(QtCore.QRect(70, 42, 121, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.DepartureImage.setGeometry(QtCore.QRect(20, 180, 31, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.FlightPlanText.setGeometry(QtCore.QRect(8, 305, 476, 111))
        self.FlightPlanText.setReadOnly(True)
        self.FlightPlanText.setObjectName(_fromUtf8("FlightPlanText"))
        self.FlightPlan_label = QtGui.QLabel(self.centralwidget)
        self.FlightPlan_label.setGeometry(QtCore.QRect(10, 285, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setWeight(75)
        font.setBold(True)
        ...
        self.GroundSpeedNumber.setGeometry(QtCore.QRect(195, 230, 91, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.AltitudeNumber.setGeometry(QtCore.QRect(375, 230, 91, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.Altitude_label.setGeometry(QtCore.QRect(390, 210, 61, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setWeight(75)
        font.setBold(True)
        ...
        self.FlightStatusNumber.setGeometry(QtCore.QRect(16, 230, 91, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.line2.setGeometry(QtCore.QRect(10, 420, 461, 16))
        ...
        self.PilotNameText.setGeometry(QtCore.QRect(129, 6, 181, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, QPilotInfo):
        ...
        self.FlightPlan_label.setText(QtGui.QApplication.translate("QPilotInfo", "Flight Plan", None, QtGui.QApplication.UnicodeUTF8))
